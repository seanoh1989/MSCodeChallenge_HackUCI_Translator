...
try {
    ...
    $clientID       = "ms_c_challenge_hack_uci";
    ...
    $detectMethodUrlArabic = "http://api.microsofttranslator.com/V2/Http.svc/Translate?Text=".urlencode($inputStr)."&To=ar";
    //Call the curlRequest.
    $strResponseArabic = $translatorObj->curlRequest($detectMethodUrlArabic, $authHeader);
    echo "Arabic: ".$strResponseArabic."<br>";
